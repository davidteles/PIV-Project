...
[imgbrgb,imgbdepth]=calculatebackground('/Volumes/Samsung_T5/PIV/Projecto/data_rgb');
depth1=imgbdepth(:,:,1);
im1=imgbrgb(:,:,1);
depth2=imgbdepth(:,:,2);
im2=imgbrgb(:,:,:,2);
...
xyz1=get_xyzasus(depth1(:),[480 640],(1:480*640)',cam_params.Kdepth,1,0);

xyz2=get_xyzasus(depth2(:),[480 640],(1:480*640)',cam_params.Kdepth,1,0);

cl1=get_rgbd(xyz1, im1, cam_params.R, cam_params.T, cam_params.Krgb);
cl2=get_rgbd(xyz2, im2, cam_params.R, cam_params.T, cam_params.Krgb);
